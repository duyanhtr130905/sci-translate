...
class PubmedCollectorSpider(BaseCollectorSpider):
    ...
    custom_settings = {
        **BaseCollectorSpider.custom_settings,
        ...
        "DEFAULT_REQUEST_HEADERS": {
            "User-Agent": "SCI-Translate/1.0 (PubMed Drive collector)"
        },
    }

    def __init__(
        self,
        en_drive_link="https://drive.google.com/file/d/15GovtRr6Zwye30mPeDqEV-JroE4jg_KR/view",
        vi_drive_link="https://drive.google.com/file/d/1QfJI4cWcZgsENEQb1zg-Gji-YTEqfN3f/view",
        max_results=None,
        output_mode="en",  # en | vi
        save_separate="true",
        en_output_file="raw/pubmed_sentences_en.json",
        vi_output_file="raw/pubmed_sentences_vi.json",
        start_id="1",
        keep_empty="false",
        *args,
        **kwargs,
        ...
        self.en_output_file = en_output_file or "raw/pubmed_sentences_en.json"
        self.vi_output_file = vi_output_file or "raw/pubmed_sentences_vi.json"
